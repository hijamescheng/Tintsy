package dev.lab.crashless.tintsy
...
import dev.lab.crashless.tintsy.ui.theme.TintsyTheme
import dev.lab.crashless.tintsy.util.PermissionChecker
import dev.lab.crashless.tintsy.view.AlbumViewModel
import dev.lab.crashless.tintsy.view.FileSaveSuccessfully
import dev.lab.crashless.tintsy.view.FilterScreen
import dev.lab.crashless.tintsy.view.MainScreen
    ...
    fun TintsyNavHost() {
        ...
        NavHost(
            ...
            composable("filter") { backStackEntry ->
                ...
                FilterScreen(uri, navController, { navController.navigate("home") })
            }
